...
현재 소스 버전은 **v0.2.0 복습 기능 추가판**입니다. v0.2.0의 실물 화면·터치 검증과 보드 업로드는 아직 하지 않았습니다.
...
**남은 작업:** 주문한 스피커의 모델/연결 방식 확인 후 발음 재생 구현, 한글 폰트 추가. 현재 Montserrat 폰트는 한글 뜻·예문을 표시하지 못하므로 기기용 콘텐츠는 영어 풀이를 사용해야 합니다. 네트워크 다운로드 중 짧은 UI 멈춤과 기존 HTTPS 인증서 검증 생략도 남아 있습니다.
